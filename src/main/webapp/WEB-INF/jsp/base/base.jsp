...
<link rel="stylesheet" type="text/css" href="<%=$root %>/js/jquery-easyui-1.4.5/themes/gray/easyui.css">
<link rel="stylesheet" type="text/css" href="<%=$root %>/js/jquery-easyui-1.4.5/themes/default/textbox.css">
<link rel="stylesheet" type="text/css" href="<%=$root %>/js/jquery-easyui-1.4.5/themes/icon.css" />
